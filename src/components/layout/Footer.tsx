          ...
          <div className="md:col-span-4">
            ...
            <div className="flex border-2 border-black dark:border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
              <input 
                ...
                className="w-full p-2 font-bold outline-none bg-white dark:bg-gray-800 text-black dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
              />
              <button className="bg-yellow-400 border-l-2 border-black dark:border-white px-4 font-black uppercase text-xs text-black hover:bg-yellow-300 transition-colors">
                Sub
              </button>
            </div>
          </div>
