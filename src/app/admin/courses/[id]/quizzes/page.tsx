    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    <button
                        onClick={() => router.push(courseSlug ? `/courses/${courseSlug}/edit` : `/admin/courses`)}
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={() => router.push(`/admin/courses/${courseId}/quizzes/create${courseSlug ? `?slug=${courseSlug}` : ''}`)}
